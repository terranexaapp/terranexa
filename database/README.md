...
| 15 | `002_storage_buckets.sql` | Buckets Storage: `mapas`, `comprovantes`, etc. |
| 16 | `003_vincular_dados_existentes.sql` | Backfill (executar **só uma vez** logo após criar seu usuário no app). |
| 17 | `004_final_check.sql` | Sanity check de RLS / tabelas. Roda no fim e reporta o que faltou. |
