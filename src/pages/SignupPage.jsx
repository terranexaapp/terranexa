      ...
      <CenterCard>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: C.textMid, fontSize: 13, lineHeight: 1.5 }}>
            Enviamos um e-mail de confirmação para <strong>{email}</strong>. Confirme seu cadastro e entre.
          </p>
          <Link
            to="/login"
            style={{
  ...
  return (
    <CenterCard>
      <div style={{ textAlign: 'center', marginBottom: 24 }}>
        ...
        <p style={{ margin: 0, fontSize: 11, color: C.textDim, fontFamily: 'monospace', letterSpacing: '2px' }}>
