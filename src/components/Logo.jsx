...
export function Logo({ size = 32 }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 160 160" fill="none">
      ...
      <line x1={44} y1={79} x2={116} y2={79} stroke={C.soil} strokeWidth={2}
        strokeDasharray="4 3" opacity="0.5" />
      <path d="M80 79 Q58 93 48 109" stroke={C.greenDk} strokeWidth={5}
        strokeLinecap="round" fill="none" />
      <path d="M80 79 Q102 93 112 109" stroke={C.greenDk} strokeWidth={5}
        strokeLinecap="round" fill="none" />
      <path d="M80 79 Q80 95 80 111" stroke={C.greenDk} strokeWidth={5}
        strokeLinecap="round" fill="none" />
